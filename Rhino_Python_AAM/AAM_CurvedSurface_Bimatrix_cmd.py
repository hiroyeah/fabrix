...
__commandname__ = "AAM_CurvedSurface_bimatrix"
...
class AAM_CurvedSurface():
    ...
    def setLayerFillT0(self, outline, layerIndex):
        """
        ...
        self.gcoder.addGcode("\n \n \n ; layer filling  LayerNo:" + str(layerIndex) + " - T0 (Toolhead 0) \n \n \n")
        self.gcoder.addGcode("M135 T0 \n")
        self.gcoder.addGcode("T0 \n")
        ...
        for i in range(int(dist/self.gcoder.getExtruderDiameter())):
            ...
            nextVec = [v*self.gcoder.getExtruderDiameter()*i*2 for v in baseVec]
    ...
    def setLayerFillT1(self, outline, layerIndex):
        ...
        for i in range(int(dist/self.gcoder.getExtruderDiameter())):
			...
			# *2 means every 2 thread for BiMatrix
            nextVec = [v*self.gcoder.getExtruderDiameter()+v*self.gcoder.getExtruderDiameter()*i*2 for v in baseVec]
