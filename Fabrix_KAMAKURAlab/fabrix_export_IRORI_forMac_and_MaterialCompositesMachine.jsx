...
resultArr.push(";IRORI_Header");
resultArr.push("")
resultArr.push("M55 P4")
resultArr.push("M54 P3")
resultArr.push("M55 P8")
resultArr.push("M54 P7")
resultArr.push("T0")
resultArr.push("G1 X50 Y5 Z100 F3000")
resultArr.push("G92 E0")
resultArr.push("G1 E0.2 F3")
resultArr.push("G1 X100 Z20 F5000")
resultArr.push("G1 Z1.5 F1000 ; modify by yuyama")
resultArr.push("G92 E0")
resultArr.push("G1 X400 E0.8 F2000")
resultArr.push("G92 E0")
resultArr.push("G1 X450 F20000")
resultArr.push("G92 E0")
resultArr.push("G1 Z5 F1000")
resultArr.push("; IRORI_Header");
//===============
...
for(i = n-1; i>=0; i--){
  ...
  var pObj2 = activeDocument.layers[i].pathItems;
              ...
              resultArr.push("; layer "+String(n-i));
                         //      resultArr.push("; ");
...
//--定型Footer
resultArr.push(";IRORI_Footer");
resultArr.push("M55 P3");
resultArr.push("M55 P5");
resultArr.push("M55 P7");
resultArr.push("M55 P8");
resultArr.push("G1 X50 Y50 Z400 F2500");
//--
