/* autogenerated by Processing revision 1293 on 2024-05-05 */
...
public class G_CODE_COMBINER extends PApplet {
...
for (i=0; i<n; i++){
  ...
  // text(i +   " / " + n +" .... " + str(int(percent))+"%", 200, 200);
   ...
   println(i +   " / " + n +" .... " + str(PApplet.parseInt(percent))+"%");
 ...
 if (list[1].equals("layer") == true ){ 
   ...
   layernum = PApplet.parseInt(listl[0]); 
...
public void fileSelectedA(File selection1) {
  if (selection1 == null) {
...
public void fileSelectedB(File selection2) {
  if (selection2 == null) {
    println("Window was closed or the user hit cancel.");
  } else {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "G_CODE_COMBINER" };
    if (passedArgs != null) {
