...
///
   ...
   //////
	...
	(dlg.dimsPnl4 = dlg.add('panel', undefined, '経過時間のテキスト表示')).helpTip = "経過時間のテキスト表示"; 
...
var seconds= parseInt((totaltime-parseInt(totaltime))*60);
coordinateText1.contents = minutes + ":" +seconds;
...
// 経過時間を計算
var plen = Math.sqrt((ksxxx-sxxx)*(ksxxx-sxxx)+(ksyyy-syyy)*(ksyyy-syyy));
totaltime= totaltime + plen/ fff;
