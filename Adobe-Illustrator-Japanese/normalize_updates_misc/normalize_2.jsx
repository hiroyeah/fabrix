...
var divide =  parseFloat(   dlg.alertBtnsPnl0.titleEt.text);
     ...
     alert( n + " layers to  "+ pObj1.length +" paths "+ divide + " "); 
...
var amari = ((Math.sqrt((x-xx)*(x-xx)+ (y-yy)*(y-yy)))-(Math.sqrt(restx*restx+resty*resty))) % ratio; 
var count = parseInt((Math.sqrt((x-xx)*(x-xx)+ (y-yy)*(y-yy))-(Math.sqrt(restx*restx+resty*resty))- amari)/ ratio); 
...
newAnchor1.anchor = [  (x + normx*Math.sqrt(restx*restx+resty*resty)+ ratio*normx*w),  (y + normy*Math.sqrt(restx*restx+resty*resty)+ratio*normy*w)];
...
newAnchor2.anchor = [  (x + normx*Math.sqrt(restx*restx+resty*resty)+ ratio*normx*(w+1)),  (y + normy*Math.sqrt(restx*restx+resty*resty)+ ratio*normy*(w+1))];
...
newAnchor1.anchor = [(x + normx*Math.sqrt(restx*restx+resty*resty)+ ratio*normx*(count)),  (y + normy*Math.sqrt(restx*restx+resty*resty)+ ratio*normy*(count))];
newAnchor1.leftDirection = newAnchor1.anchor;
newAnchor1.rightDirection = newAnchor1.anchor;
newAnchor1.pointType = PointType.CORNER;
...
newAnchor2.anchor = [  (x + normx*Math.sqrt(restx*restx+resty*resty)+ ratio*normx*(count) + normx*amari),   (y + normy*Math.sqrt(restx*restx+resty*resty)+ ratio*normy*(count) + normy*amari)];
newAnchor2.leftDirection = newAnchor2.anchor;
newAnchor2.rightDirection = newAnchor2.anchor;
newAnchor2.pointType = PointType.CORNER;
...
newAnchor2.anchor = [  (x + ratio*normx*(count) + normx*amari),   (y + ratio*normy*(count) + normy*amari)];
newAnchor2.leftDirection = newAnchor2.anchor;
newAnchor2.rightDirection = newAnchor2.anchor;
newAnchor2.pointType = PointType.CORNER;
