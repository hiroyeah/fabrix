...
if (headnum==2){
	...
	alert ("we are going to generate two g-code files!");
...
// 破線の場合
 if (parseFloat(activeDocument.layers[i].pathItems[j].strokeDashes) > 0) {
    ...
    if (tt==1) { 
    resultArrT1.push("T1");
    resultArrT1.push("G1 X"+x+" Y"+y+ " Z"+z+" F"+h); 
    } else { 
	resultArrT2.push("T1");
    resultArrT2.push("G1 X"+x+" Y"+y+ " Z"+z+" F"+h); 
	}
  ...
  if (tt==1) {
    ...
    resultArrT1.push("G1 E"+extrudetwo +" F1800.00000");
    resultArrT1.push("; --------------------------------");
  } else {
   resultArrT2.push("; ----Rectract Motion (Start)-----");
   resultArrT2.push("G1 E"+extrudetwo +" F1800.00000");
   resultArrT2.push("; --------------------------------");	    
  }
...
// 最初の点(K=0)の場合'以外'
     ...
     extrude = extrude + e;
	  ...
	  resultArrT2.push("T0");
      resultArrT2.push("G1 X"+x+" Y"+y+ " Z"+z+" E"+extrude+" F"+h); 	 
  ...
  if (tt==1) { 
      resultArrT1.push("T1");
      resultArrT1.push("G1 X"+x+" Y"+y+ " Z"+z+" E"+extrudetwo+" F"+h); 
  } else { 
      resultArrT2.push("T1");
      resultArrT2.push("G1 X"+x+" Y"+y+ " Z"+z+" E"+extrudetwo+" F"+h); 
...
////リトラクト
 ...
 if (tt==1) {
resultArrT1.push("; Layer:"+activeDocument.layers[i].name+" failed.");
 } else { 
resultArrT2.push("; Layer:"+activeDocument.layers[i].name+" failed."); 
 }
}
}
