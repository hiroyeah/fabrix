...
var defaultValue7s = 20; //rectract
var defaultValue7y = 20; //rectract
...
var defaultValue13 = extrudewidth; //印刷幅
    ...
    (dlg.alertBtnsPnl2.titleSt = dlg.alertBtnsPnl2.add('statictext', [10,15,360,35], '線の透明度をF(速度)値に変換する係数 *100されます')).helpTip = "times"; 
    ...
    (dlg.alertBtnsPnl7z.titleSt = dlg.alertBtnsPnl7z.add('statictext', [10,15,360,35], 'T1ヘッド- リトラクトの引き戻し長さ (mm)')).helpTip = "times"; 
    ...
    (dlg.alertBtnsPnl7u.titleSt = dlg.alertBtnsPnl7u.add('statictext', [10,15,360,35], 'T2ヘッド- リトラクトの引き戻し長さ (mm)')).helpTip = "times"; 
     dlg.alertBtnsPnl7u.orientation='row';
	 
	     dlg.alertBtnsPnl7s = dlg.add('group',undefined, 'Threshold:');
    (dlg.alertBtnsPnl7s.titleEt = dlg.alertBtnsPnl7s.add('edittext', [100,15,160,35], 0)).helpTip = ""; 
     dlg.alertBtnsPnl7s.titleEt.text = defaultValue7s; 
    (dlg.alertBtnsPnl7s.titleSt = dlg.alertBtnsPnl7s.add('statictext', [10,15,360,35], 'リトラクトの速度')).helpTip = "mm"; 
     dlg.alertBtnsPnl7s.orientation='row';
    ...
    (dlg.alertBtnsPnl7a.titleSt = dlg.alertBtnsPnl7a.add('statictext', [10,15,360,35], 'リトラクト前のZ持ち上げ')).helpTip = "mm"; 
     dlg.alertBtnsPnl7a.orientation='row';
	       ...
	       dlg.alertBtnsPnl7y = dlg.add('group',undefined, 'Threshold:');
    (dlg.alertBtnsPnl7y.titleEt = dlg.alertBtnsPnl7y.add('edittext', [100,15,160,35], 0)).helpTip = ""; 
     dlg.alertBtnsPnl7y.titleEt.text = defaultValue7y; 
    (dlg.alertBtnsPnl7y.titleSt = dlg.alertBtnsPnl7y.add('statictext', [10,15,360,35], 'リトラクト前のZ持ち上げの速度')).helpTip = "mm"; 
     dlg.alertBtnsPnl7y.orientation='row';
	 
	   dlg.alertBtnsPnl3 = dlg.add('group',undefined, 'Threshold:');
     dlg.dimsPnl3 = dlg.add('panel', undefined, 'ミリ／ポイント換算 (/2.834645をする)'); 
     dlg.dimsPnl3.orientation='row';
    (dlg.dimsPnl3.selectX = dlg.dimsPnl3.add('radiobutton', [5,115,180,135], 'する' )).helpTip = ""; 
    (dlg.dimsPnl3.selectY = dlg.dimsPnl3.add('radiobutton', [5,140,180,160], 'しない' )).helpTip = "";


	dlg.dimsPnl3.selectX.value = true; 
	dlg.dimsPnl3.selectY.onClick= setTextX;
	dlg.dimsPnl3.selectY.onClick= setTextY;
	 
	 
     dlg.alertBtnsPnl8 = dlg.add('group',undefined, 'Threshold:');
     dlg.dimsPnl8 = dlg.add('panel', undefined, '機種とエクストルーダ数'); 
     dlg.dimsPnl8.orientation='row';
    (dlg.dimsPnl8.selectQ = dlg.dimsPnl8.add('radiobutton', [5,115,180,135], 'TATAMI 1ヘッド' )).helpTip = ""; 
    (dlg.dimsPnl8.selectR = dlg.dimsPnl8.add('radiobutton', [5,140,180,160], 'TATAMI 2ヘッド' )).helpTip = "";
    (dlg.dimsPnl8.selectQQ = dlg.dimsPnl8.add('radiobutton', [5,140,180,160], 'IRORI 1ヘッド' )).helpTip = "";

	dlg.dimsPnl8.selectQ.value = true; 
	dlg.dimsPnl8.selectQ.onClick= setTextQ;
	dlg.dimsPnl8.selectR.onClick= setTextR;
	dlg.dimsPnl8.selectQQ.onClick= setTextQQ;
...
var retspeed =  parseFloat (   dlg.alertBtnsPnl7s.titleEt.text); 
var retnozspeed =  parseFloat (   dlg.alertBtnsPnl7y.titleEt.text); 
...
if (irori == 1) {
     ...
     resultArrT1.push("; IRORI - Tool Head 1"); 
	 
	 resultArrT1.push(";T1 175 T2 185 T3 195 T4 195 BED 80");
	 resultArrT1.push(";FAI 2.0");
	 resultArrT1.push(";TYOUSEI 80%");
	 resultArrT1.push(";FR 100%");
	 resultArrT1.push(";BANTYOU");
	 resultArrT1.push(";SENPOUKI 2-KYOU");
	 resultArrT1.push("; ");
	 resultArrT1.push("M55 P5 ");
	 resultArrT1.push("M55 P4 ");
	 resultArrT1.push("M54 P3 ");
	 resultArrT1.push("M55 P8 ");
	 resultArrT1.push("M54 P7 ");
	 resultArrT1.push("T0 ");
	 resultArrT1.push("G1 X50 Y5 Z100 F3000 ");
	 resultArrT1.push("G92 E0 ");
	 resultArrT1.push("G1 E0.2 F3 ");
	 resultArrT1.push("G1 X100 Z20 F5000 ");
	 resultArrT1.push("G1 Z2.0 F1000 ; modify by yuyama ");
 	 resultArrT1.push("G92 E0 ");
	 resultArrT1.push("G1 X400 E0.3 F2000 ");
	 resultArrT1.push("G92 E0 ");
	 resultArrT1.push("G1 E-0.03 F30 ");
	 resultArrT1.push("G1 X450 F20000 ");
	 resultArrT1.push("G92 E0 ");
	 resultArrT1.push("G1 Z5 F1000 ");

	
} else { 

     resultArrT1.push("; TATAMI - Tool Head 1"); 
...
///
     ...
     resultArrT2.push("; TATAMI - Tool Head 2"); 
...
// １ヘッドモード
    ...
    if (retractpull>0) {
        ...
        resultArrT1.push("G1 E"+extrude+" F"+ retspeed );
		
		        z = parseFloat(z) + parseFloat(retractzup); 
        resultArrT1.push("G1 Z"+z+" F"+retnozspeed);
        ...
        resultArrT2.push("G1 E"+extrude+" F"+retspeed);
		
			    z = parseFloat(z) + parseFloat(retractzup); 
        resultArrT2.push("G1 Z"+z+" F"+ retnozspeed );
        resultArrT2.push("; --------------------------"); 	
...
if (irori == 1) {
	resultArrT1.push("; IRORI T1 Footer");
	resultArrT1.push("M55 P3 ");
	resultArrT1.push("M55 P5 ");
	resultArrT1.push("M55 P7 ");
	resultArrT1.push("M55 P8 ");
	resultArrT1.push("G1 X50 Y50 Z400 F2500 ");

} else {
	
//--定型Footer
resultArrT1.push("; TATAMI T1 Footer");
...
resultArrT1.push("; 定型Footerここまで");


//--
resultArrT2.push("; TATAMI T2 Footer");
resultArrT2.push("G1 Y1400 F3600");
resultArrT2.push("M400");
resultArrT2.push("M42 P8 S255");
resultArrT2.push("M400");
