...
var defaultValue13 = extrudewidth; //印刷幅
    ...
    (dlg.alertBtnsPnl7.titleSt = dlg.alertBtnsPnl7.add('statictext', [10,15,360,35], 'リトラクトの押し長さ (mm)')).helpTip = "times"; 
    ...
    (dlg.alertBtnsPnl7z.titleSt = dlg.alertBtnsPnl7z.add('statictext', [10,15,360,35], 'リトラクトの戻し長さ (mm)')).helpTip = "times"; 
...
var T2x = 2.834645 * parseFloat (dlg.alertBtnsPnl0a.titleEt.text);
var T2y = 2.834645 * parseFloat (dlg.alertBtnsPnl1a.titleEt.text);
...
// 最初の点までは樹脂を出さないで単なる移動
  ...
  if (tt==1) { 
    ...
    resultArrT2.push("T0");
    resultArrT2.push("G1 X"+x+T2x+" Y"+y+ T2y+" Z"+z+" F"+freemove); //T1T2湯浅補正あり
...
// 最初の点(K=0)の場合'以外'
     ...
     extrude = extrude + e;
	  ...
	  resultArrT2.push("T0");
      resultArrT2.push("G1 X"+x+T2x+" Y"+y+ T2y+" Z"+z+" E"+extrude+" F"+h); 	 //T1T2湯浅補正あり	 
