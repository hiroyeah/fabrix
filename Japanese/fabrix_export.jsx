...
var defaultValue13 = extrudewidth; //印刷幅
	...
	(dlg.dimsPnl9.selectS = dlg.dimsPnl9.add('radiobutton', [5,115,180,135], 'すべて一定' )).helpTip = ""; 
	...
	(dlg.dimsPnl10b = dlg.add('panel', undefined, '上記で「線分の長さに比例」を選択した場合は下記の１項目だけ入力')).helpTip = "上記で「線分の長さに比例」を選択した場合は下記の１項目だけ入力"; 
	(dlg.dimsPnl10 = dlg.add('group', undefined, '上記で「線分の長さに比例」を選択した場合は下記の１項目だけ入力')).helpTip = ""; 

     (dlg.dimsPnl10.titleEt = dlg.dimsPnl10.add('edittext', [100,15,160,35], 0)).helpTip = ""; 
      dlg.dimsPnl10.titleEt.text = defaultValue10; 
    (dlg.dimsPnl10.titleSt = dlg.dimsPnl10.add('statictext', [10,15,360,35], '線分の長さをE値に自動換算する場合の乗数')).helpTip = "times"; 
